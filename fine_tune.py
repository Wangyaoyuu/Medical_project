...
dataset = 'Fundus'
model_name = 'Efficient-fine'  # ['ViT','ResNet50', 'ResNet50_sl1', 'Efficient', 'Efficient-onehot']


model = load_model(model_name)
model._fc.weight.data.normal_()

batchsize = 16
base_output_path = './output/'
weight_path = base_output_path + dataset + '/' + 'Efficient-pretrain'
# weight_path = base_output_path + dataset + '/' + model_name
save_path = base_output_path + dataset + '/' + model_name
fileEnd = '.h5'
...
for i in range(epoches):
    ...
    if q > best:
        ...
        pt.save({'epoch': i, 'best': best,
                 ...
                 'scheduler': scheduler.state_dict()}, save_path + '/model')
